...
- **사용자 관리 API**
  - JWT 기반의 회원가입, 로그인
![Image](https://github.com/user-attachments/assets/9167c832-b964-4e47-b3c2-bcf82023aa6a)
  - 사용자 계정 잠금/해제 및 권한 부여/차단 기능
![Image](https://github.com/user-attachments/assets/8a430a8f-8172-4b29-aded-d121862eadf7)
  - 비밀번호 초기화 및 이메일을 통한 임시 비밀번호 발급
![Image](https://github.com/user-attachments/assets/b7d72ee3-6c0a-470c-a064-3b4b7413699b)
---
...
- [x] **의상 추천 시스템** - 날씨, 프로필, 보유 의상을 조합한 의상 추천 로직 설계
