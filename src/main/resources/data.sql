...
-- notifications (30)
INSERT INTO notifications (id, receiver_id, created_at, title, content, level) VALUES
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 팔로워', 'user_six님이 회원님을 팔로우하기 시작했습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 댓글', 'user_seven님이 회원님의 피드에 댓글을 남겼습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '피드 좋아요', 'user_eight님이 회원님의 피드를 좋아합니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '시스템 공지', '새로운 기능이 추가되었습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '계정 관련', '개인정보 처리 방침이 업데이트되었습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 팔로워', 'user_nine님이 회원님을 팔로우하기 시작했습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 댓글', 'user_ten님이 회원님의 피드에 댓글을 남겼습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '피드 좋아요', 'user_eleven님이 회원님의 피드를 좋아합니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '시스템 공지', '서버 점검이 예정되어 있습니다.', 'WARNING'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '계정 관련', '오랫동안 접속하지 않아 휴면 계정으로 전환될 예정입니다.', 'WARNING'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 팔로워', 'user_twelve님이 회원님을 팔로우하기 시작했습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 댓글', 'user_thirteen님이 회원님의 피드에 댓글을 남겼습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '피드 좋아요', 'user_fourteen님이 회원님의 피드를 좋아합니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '시스템 공지', '이벤트가 시작되었습니다! 참여해보세요.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '계정 관련', '새로운 기기에서 로그인이 감지되었습니다.', 'WARNING'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 팔로워', 'user_fifteen님이 회원님을 팔로우하기 시작했습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 댓글', 'user_sixteen님이 회원님의 피드에 댓글을 남겼습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '피드 좋아요', 'user_seventeen님이 회원님의 피드를 좋아합니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '시스템 공지', '앱 업데이트가 있습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '계정 관련', '비밀번호가 곧 만료됩니다.', 'WARNING'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 팔로워', 'user_eighteen님이 회원님을 팔로우하기 시작했습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 댓글', 'user_nineteen님이 회원님의 피드에 댓글을 남겼습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '피드 좋아요', 'user_twenty님이 회원님의 피드를 좋아합니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '시스템 공지', '긴급 서버 점검이 있습니다.', 'WARNING'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '계정 관련', '이메일 주소를 인증해주세요.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 팔로워', 'user_twentyone님이 회원님을 팔로우하기 시작했습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '새로운 댓글', 'user_twentytwo님이 회원님의 피드에 댓글을 남겼습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '피드 좋아요', 'user_twentythree님이 회원님의 피드를 좋아합니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '시스템 공지', '서비스 이용약관이 변경되었습니다.', 'INFO'),
(gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', NOW(), '계정 관련', '프로필 정보를 업데이트해주세요.', 'INFO');
